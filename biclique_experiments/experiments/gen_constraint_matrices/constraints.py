...
parser.add_argument('--bicfile', type=str, default='../../datafiles/AllBicliques/3DKDallbicliques.txt', help='all bicliques file path')
...
for i in range(len(all_biclique_tuples)):
    ...
    for edge in List_of_Edges:
        ...
        if edge[0] in L0 and edge[1] in L1:
            M[edge_position][i]=1        
save_path=constraint_folder+bicfile_path[29:-16]+"constraints.npy"
Mx=np.array(M)
np.save(save_path, Mx)
new_save_path=constraint_folder+bicfile_path[29:-16]+"constraints.txt"
